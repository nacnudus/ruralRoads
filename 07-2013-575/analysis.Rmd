...
ggplot(crashes, aes(year, group = urbanRural, fill = urbanRural, colour = "black")) + 
...
ggplot(crashes, aes(year, weight = countRoad, group = urbanRuralRoadHighway
                    , fill = urbanRuralRoadHighway, colour = "black")) + 
...
ggplot(crashes[!is.na(crashes$hour) & crashes$alcohol == TRUE, ]
       , aes(hour, weight = count
             , fill = as.character(excelPalette[1]), colour = "black")) + 
  geom_bar(binwidth = 1) +
